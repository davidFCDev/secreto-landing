...
const Description = () => {
  return (
    <div className="flex flex-col py-14 small:py-24 items-center w-full">
      <div className="flex w-full">
        <div className="flex flex-col gap-10 small:gap-24 items-center justify-between w-full">
          ...
          <div className="w-full grid grid-cols-1 small:grid-cols-2 gap-2">
            <div className="bg-base-100 p-4 small:p-10 flex flex-col gap-4 group">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-2xl small:text-3xl font-semibold">Los inicios</h2>
              </div>
            ...
            <div className="bg-base-100 p-4 small:p-10 flex flex-col gap-4 group">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-2xl small:text-3xl font-semibold">Mi marca personal</h2>
              </div>
              <p className="text-justify leading-relaxed font-light text-sm small:text-base">
